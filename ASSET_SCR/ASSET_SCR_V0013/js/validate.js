...
function validateAddAsset() {
	var selectBoxAdd = document.getElementById("addAssetType");
    var selectedValueType = selectBoxAdd.options[selectBoxAdd.selectedIndex].value;
	var selectBoxAdd = document.getElementById("addAssetGroup");
    var selectedValueGroup = selectBoxAdd.options[selectBoxAdd.selectedIndex].value;
	...
	{ 
		...
		if(!regExp.test($('#addAssetCode').val())){
			...
			$.get("../request/reqCheckAsset.php",{'assetTypeId':selectedValueType,
			'assetGroupId':selectedValueGroup,
