	...
	<div class="manage">
        ...
        ค้นหาเลขครุภัณฑ์ : <input id='searchAsset' type='text' style='width: 150px;' placeholder='xx/xx-xxxx-xxx' onKeyDown="searchAsset(event);">
        <a class="button big icon search" onclick="searchAsset(event);">ค้นหา</a></br></br>
        <table>
