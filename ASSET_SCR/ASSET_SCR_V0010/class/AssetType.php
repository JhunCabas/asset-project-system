<?php
	...
	class AssetType{
		...
		function getAssetType($search)
		{
			
			return mysql_query('SELECT id,assetTypeCode,assetTypeName FROM assettype WHERE assetTypeName LIKE "%'.$search.'%" ORDER BY assetTypeCode ASC');
		}
