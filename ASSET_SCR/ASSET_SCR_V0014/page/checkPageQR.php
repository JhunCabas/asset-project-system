    ...
    <div id="checkQRMo" class="check">
	  ...
	  ?>
        ...
        <a class="button big icon approve"  onClick="onCheckQrY(<?php echo $encode ?>);" style='width: 200px;'><font size="4">ใช้งานได้</font></a>
		</br></br>
        <a class="button big icon remove danger" onClick="onCheckQrN(<?php echo $encode ?>);" style='width: 200px;'><font size="4">ชำรุด</font></a>
		</br></br>
        <a class="button big icon trash danger" onClick="onCheckQrD(<?php echo $encode ?>);" style='width: 200px;'><font size="4">เสื่อมสภาพ</font></a>
		</br></br>
        </center>
