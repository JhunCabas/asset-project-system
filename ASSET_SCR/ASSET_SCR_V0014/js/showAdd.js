...
{  
	...
	$('#addAsset').html($('#addAsset').html()+'&nbsp&nbsp&nbsp<input id="addAssetNum" type="text" placeholder="จำนวน" maxlength="2" style="width: 50px;">&nbsp ชิ้น * หากเพิ่ม 1 ชิ้นให้เว้นไว้');
	...
	$('#addAsset').html($('#addAsset').html()+'<input id="btmClrGroup" type="button" class="button big danger" value="ล้างค่า" onClick="clearAddAsset();"/></center>');
