					  ...
					  buttons: {
						'ตกลง': function() {
							...
							{ 
								...
								$('#dialog2').dialog({'title':'เกิดข้อผิดพลาด',
					  ...
					  buttons: {
						'ตกลง': function() {
							...
							{ 
								...
								$.get("../request/reqEditGroup.php",{'assetGroupId':assetGroupId,'editGname':$('#editGname').val()},function(data)
										{
											$('#dialog').dialog('close');
											showManageGroup();
											getTableGroup();
