	...
	while($res = $db->fetch_array($cmd))
{
	...
	echo "<td style='text-align:center'><a class='button icon edit' onClick='getEditGroup(".$res['assetGroupId'].");'></a></td>";
	echo "<td style='text-align:center'><a class='button icon remove danger' onClick='delGroup(".$res['assetGroupId'].");'></a></td>";
	echo "</tr>";
