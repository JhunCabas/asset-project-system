<?php
	...
	class CheckAsset{
		...
		function getCheckYear($year)
		{
			...
			return mysql_query('SELECT SUBSTR(checkDate,1,4) AS checkDate FROM checkasset GROUP BY checkDate HAVING SUBSTR(checkDate,1,4) = "'.$year.'" ORDER BY checkDate DESC');
		}
